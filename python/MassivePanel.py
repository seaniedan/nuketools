...
############# setting help messages
        ...
        KindInfo = "Type of value you want to set."
...
#############creating knobs
        ...
        self.Kind = nuke.Enumeration_Knob(KindInfo,"                                                                        Kind:",[ "Float", "Integer", "String", "Expression"],)
        ...
        self.FindWhat = nuke.String_Knob( FindWhatInfo, "Find:")
        self.FindWhat.clearFlag(nuke.STARTLINE)
        self.ReplaceWhat = nuke.String_Knob( ReplaceWhatInfo, "Replace:")
        self.ReplaceWhat.clearFlag(nuke.STARTLINE)
        self.Replace = nuke.PyScript_Knob("Replace", "Go")
...
######## setting integer values #added by Sean 2017
                if array== "All" and kind == "Integer":
                     Value = int(Value)
                     for n in n:
                        n[Knob].setValue(Value+ u)
                        u = incr+ u
                if array== "X" and kind == "Integer":
                     Value = int(Value)
                     for n in n:
                        n[Knob].setValue(Value+u, 0) 
                        u = incr+ u  
                if array== "Y" and kind == "Integer":
                     Value = int(Value)
                     for n in n:
                        n[Knob].setValue(Value+u, 1) 
                        u = incr+ u  
                if array== "Z" and kind == "Integer":
                     Value = int(Value)
                     for n in n:
                        n[Knob].setValue(Value+ u, 2)
                        u = incr+ u
                if array== "W" and kind == "Integer":
                     Value = int(Value)
                     for n in n:
                        n[Knob].setValue(Value+ u, 3)
                        u = incr+ u
