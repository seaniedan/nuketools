...
class SearchReplacePanel( nukescripts.PythonPanel ):
    def __init__( self, historyFile='~/.nuke/srhistory.xml', maxSteps=10 ):
        ...
        '''
        nukescripts.PythonPanel.__init__( self, 'Search and Replace', 'com.ohufx.SearchReplace_sd')
...
nuke.menu('Pane').addCommand('Search and Replace', addSRPanel)

#THIS LINE WILL REGISTER THE PANEL SO IT CAN BE RESTORED WITH LAYOUTS
nukescripts.registerPanel('com.ohufx.SearchReplace_sd', addSRPanel)
